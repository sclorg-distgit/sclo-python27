...
Name:           %{?sub_prefix}python-backports-ssl_match_hostname
Version:        3.5.0.1
Release:        4%{?dist}
...
Requires:       %{?scl_prefix}python-backports
...
%if 0%{?scl:1}
Provides: %{?scl_prefix}python-backports-ssl_match_hostname = %{version}-%{release}
Provides: %{?scl_prefix}python2-backports-ssl_match_hostname = %{version}-%{release}
...
%{python_sitelib}/backports.ssl_match_hostname-%{version}-*egg*
